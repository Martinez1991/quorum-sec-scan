...
Cross-links: [DESIGN.md](https://github.com/Martinez1991/quorum-sec-scan/blob/main/DESIGN.md) (modelo de dados, matriz de correlação §6,
matemática do consenso, alias §7), [README.md](https://github.com/Martinez1991/quorum-sec-scan/blob/main/README.md).
